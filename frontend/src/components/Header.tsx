      ...
      <header className="w-full h-20 p-4 shadow flex justify-between items-center gap-4 bg-primary text-text">
        ...
        <div className="flex flex-row justify-center items-center ">
          ...
          <div className="relative flex items-center justify-center">
            ...
            {/* Notification Drawer */}
            {isNotificationOpen && (
              <div className="absolute top-12 right-0 w-80 max-h-[24rem] bg-secondary border border-gray-700 shadow-2xl rounded-xl p-4 z-50 overflow-y-auto custom-scroll">
